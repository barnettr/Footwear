(function (jQuery) {
    ...
    var methods = {
        ...
        getMenSliders: function (options) {
            ...
            jQuery(".tabs").css('background-color', '#4d515b');
            ...
            /*jQuery(function () {
                if (jQuery("#slider_container .tabs.selected .panel.selected")) {
                    if (jQuery(".container .photoleft .leftimage")) {
                        console.log('found');
                        jQuery(".container .photoleft .leftimage").imageloader();
                    }
                }
            });*/
            ...
            jQuery("ul#coords_wrapper_men li#tab_1").bind('click', function () {
                ...
                $notSelected.stop(true, true).fadeOut(400, function () {
                    $notSelected.removeClass("selected").addClass("hidden").css({ display: 'none' });
                });
                $activePanel.stop(true, true).fadeIn(400, function () {
                    $activePanel.addClass("selected").removeClass("hidden").css({ display: 'block' });
                });
